...
/**
 * Converts the size prop to a class name
 * Needed because Tailwind doesn't support dynamic class names and only compiles the classes it knows about
 */
const sizeToClass: {
  xs: ComponentProps<'div'>['className'];
  s: ComponentProps<'div'>['className'];
